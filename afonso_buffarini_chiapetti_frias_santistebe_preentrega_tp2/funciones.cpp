...
void dibujarLogoWeylandYutaniASCII() {
...
// Implementacion de limpiar y dibujar marco 
...
void mostrarMenuPrincipal() {
    ...
    // Llamamos a la nueva funcion para dibujar el logo ASCII
    dibujarLogoWeylandYutaniASCII(); 
...
// (El resto de funciones como mostrarOpciones, mostrarCreditos, esperarEnter)
